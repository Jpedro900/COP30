...
export default class destaquenoticias extends Component {
  render() {
    return (
        <section>
            <div className=' px-10 mb-12'>
                <div>
                        <img src={img1} alt="Image 1" className=' mb-6 '/>
                </div>
            ...
            <div className=' px-10 mb-12'>
                <div>
                    <img src={img2} alt="Image 1" className=' mb-6 '/>
                </div>
                <h1 className=' font-Header text-3xl text-justify'>
            ...
            <div className=' px-10 mb-12'>
                <div>
                    <img src={img3} alt="Image 1" className=' mb-6'/>
                </div>
                <h1 className=' font-Header text-3xl text-justify'>
