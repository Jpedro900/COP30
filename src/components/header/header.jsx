...
export default class header extends Component {
  render() {
    return (
        <header className=' bg-gradient-to-r from-blue-600 to-blue-800 h-16 flex justify-between text-white px-10 content-center mb-[0.5px] shadow-lg font-Header tracking-widest'>
